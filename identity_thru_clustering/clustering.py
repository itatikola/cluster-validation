...
def main(original_hdf):
    ...
    for i in range(0, 18, 2):
        overlay_histogram(ind1_stats.iloc[:, i], ind2_stats.iloc[:, i], stats.columns[i])
...
def visualize(metadata, action='partition', data=None, labels=None, cluster_type=kmeans):
    '''
...
def overlay_histogram(column_one, column_two, proportion):
